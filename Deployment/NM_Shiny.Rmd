...
```{r}
HTML(paste("In this dashboard, you will find information on the how each county is affected by changes in the Clean Water Act. These legislative changes means that some waterways will no longer be protected. Some places and public water systems will be more affected than others. This dashboard will not only show where, but also the socio-economic characteristics of each of these places using the Human Development Index (HDI) and Drinking Water Vulnerability Index.", "The HDI is a statistic used by the United Nations to rank countries into tiers of human development. It looks at life expectancy, education, and per capita income. This has been modified to for use in New Mexico where it is to rank and evaluate each county in terms of its human development.", "The Drinking Water Vulnerability Index evaluates how public water systems are impacted and economically disadvantaged, on a scale of 1 to 10, with 10 being the worst. Broadly speaking, it takes into consideration household income, degree to which the system is impacted, and the availability of alternative sources of water.", sep = "<br/>"))
```
